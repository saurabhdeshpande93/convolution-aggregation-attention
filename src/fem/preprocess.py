...
class Preprocess():
    ...
    def reorder(X,dof,dim):
        ...
        But for efficient use of CNNs we need to re-arrange all x, y dofs in
        separate channels. This is a helper function to rearrange dofs. This
        can be more efficiently done using np.transpose options.
